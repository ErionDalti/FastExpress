...
class _AddNewAddressState extends State<AddNewAddress> {
  ...
  Future<bool> _saveAddress() async {
    ...
    //   "address_line_2": addressController.text,
    //   "pincode": "1001",
    //   "latitude": "41.330961",
    //   "longitude": "19.7477833",
    //   "city": "Tirane",
    //   "state": "Albania",
    //   "country": "Albania",
                          ...
                          children: <Widget>[
                            ...
                            new Container(
                              child: new Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: <Widget>[
                                  setCommonText(S.current.your_address,
                                      Colors.grey, 16.0, FontWeight.w500, 1),
                                  new TextFormField(
                                    controller: addressController,
                                    decoration: InputDecoration(
                                      hintText: S.current.your_address,
                            ...
                            new Container(
                              child: new Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: <Widget>[
                                  setCommonText(S.current.your_city,
                                      Colors.grey, 16.0, FontWeight.w500, 1),
                                  new TextFormField(
                                    controller: cityController,
                                    decoration: InputDecoration(
                                      hintText: S.current.your_city,
                                      hintStyle: TextStyle(color: Colors.grey),
                                    ),
                                    style: new TextStyle(
                                      color: Colors.black,
                            ...
                            new Container(
                              child: new Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: <Widget>[
                                  setCommonText(S.current.your_state,
                                      Colors.grey, 16.0, FontWeight.w500, 1),
                                  new TextFormField(
                                    controller: stateController,
                                    decoration: InputDecoration(
                                      hintText: S.current.your_state,
                                      hintStyle: TextStyle(color: Colors.grey),
                                    ),
                                    style: new TextStyle(
                                      color: Colors.black,
