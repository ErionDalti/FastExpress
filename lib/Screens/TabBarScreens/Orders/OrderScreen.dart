...
//5 delivered
  ...
  List<OrderStatus> orderStatusList = [
    OrderStatus('Të gjitha', true, '0'),
    OrderStatus('Marrë', false, '1'),
    OrderStatus('Pranuar', false, '2'),
    OrderStatus('Refuzuar', false, '3'),
    OrderStatus('Duke u përgatitur', false, '4'),
    OrderStatus('Dërguar', false, '5'),
    OrderStatus('Anulluar', false, '9'),
  ];
