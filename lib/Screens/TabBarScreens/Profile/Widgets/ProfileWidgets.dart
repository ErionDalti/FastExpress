...
void showAlertDialogforLogout(String message, BuildContext context) {
    ...
    builder: (BuildContext context) {
      ...
      return AlertDialog(
        ...
        actions: <Widget>[
          ...
          new FlatButton(
            child: setCommonText('${S.current.cancel}', AppColor.themeColor,
                13.0, FontWeight.w500, 2),
            onPressed: () {
              Navigator.of(context).pop();
            },
          ),
          new FlatButton(
            child: setCommonText('${S.current.ok}', AppColor.themeColor, 13.0,
                FontWeight.w500, 2),
            onPressed: () async {
              await SharedManager.shared.storeString("no", "isLoogedIn");
              SharedManager.shared.currentIndex = 2;
              ...
              Expanded(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    setCommonText('${S.current.thankful}', AppColor.grey[600],
