...
//Define the variable on the top
  ...
  TextEditingController pakoCharge = TextEditingController();
...
//This is the place where you have to create the all widgets
            ...
            child: new Container(
              ...
              child: new Row(
                ...
                children: <Widget>[
                  new Row(
                    children: <Widget>[
                      setCommonText(S.current.item_total, Colors.black, 14.0,
                          FontWeight.w500, 2),
                    ],
                  ),
                  new Row(
                    children: <Widget>[
                      ...
                      //         Colors.black, 14.0, FontWeight.w500, 1),
                      //     new Container(
                      //         width: 50, height: 2, color: Colors.black),
                      //   ],
                      // ),
                      //     SizedBox(
                      //       width: 6,
              ...
              child: new Row(
                ...
                children: <Widget>[
                  ...
                  new Expanded(
                    flex: 5,
                    child: new TextFormField(
                        controller: pakoCharge,
                        onChanged: (pakoCharge) {
                          setState(() {
                            if (pakoCharge.isEmpty) {
                              SharedManager.shared.deliveryCharge = 0;
                            }
                            _applycalculateDeliveryCharges();
                          });
                        },
                        decoration: InputDecoration(
                            hintText: S.current.apply_PackageCost,
                            hintStyle: new TextStyle(
                                color: AppColor.themeColor, fontSize: 14),
                            border: InputBorder.none,
                            suffixText: '${Currency.curr}'),
                  ...
                  Expanded(
                      ...
                      child: InkWell(
                        onTap: () {
                          showAlertDialogforCart(
                              'Deshironi te konfirmoni?', context);
                        },
                        child: Container(
                          child: Center(
                              child: setCommonText('${S.current.apply}',
                                  AppColor.black87, 14.0, FontWeight.w500, 1)),
                        ),
                      ))
                ],
              ),
                  ...
                  children: <Widget>[
                    new Row(
                      ...
                      children: <Widget>[
                        new Row(
                          children: <Widget>[
                            setCommonText(S.current.item_total, Colors.black,
                        ...
                        new Row(
                          children: <Widget>[
                            ...
                            setCommonText('${Currency.curr}${this.totalPrice}',
                                Colors.black, 13.0, FontWeight.w500, 1),
                          ],
                        ),
                      ],
                    ),
                    ...
                    new Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: <Widget>[
                        setCommonText(S.current.charges, Colors.black, 13.0,
                            FontWeight.w500, 1),
                        SizedBox(
                          width: 6,
                        ),
                        setCommonText(
                            '${Currency.curr}${SharedManager.shared.deliveryCharge}',
                            Colors.red,
                            13.0,
                            FontWeight.w500,
                            1),
  ...
  void showAlertDialogforCart(String message, BuildContext context) {
      ...
      builder: (BuildContext context) {
        ...
        return AlertDialog(
          ...
          actions: <Widget>[
            ...
            new FlatButton(
              child: new Text("Anullo"),
              onPressed: () {
                setState(() {
                  Navigator.of(context).pop();
                  pakoCharge.text = '';
                  SharedManager.shared.deliveryCharge = 0.0;
                });
              },
            ),
          ],
  ...
  //                     child: InkWell(
  //                       onTap: () {
  //                         // calculateDeliveryCharges(Convert.(pakoCharge.text));
  //                       },
  //                       child: Container(
  //                         child: Center(
  //                             child: setCommonText('${S.current.apply}',
  ...
  _applycalculateDeliveryCharges() {
    ...
    calculateDeliveryCharges((double.parse(pakoCharge.text)));
    print(double.parse(pakoCharge.text));
  }
