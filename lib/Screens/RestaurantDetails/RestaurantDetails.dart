...
class RestaurantDetails extends StatefulWidget {
  ...
  RestaurantDetails({Key key, this.restaurantID, this.categoryID})
      : super(key: key);
...
class _RestaurantDetailsState extends State<RestaurantDetails> {
  ...
  void initState() {
    ...
    resDetailsBloc.restaurantDetails.forEach((element) {
      //var categories = element.result.categories;
      element.result.categories.forEach((element) {
        if (element.categoryId == this.widget.categoryID) {
          list.add(element);
        }
      });
      print(json.encode(list));
    });
    //resDetailsBloc = resDetailsBloc.restaurantDetails
    super.initState();
      ...
      body: StreamBuilder(
          ...
          builder: (context, AsyncSnapshot<ResRestaurantDetails> snapshot) {
            if (snapshot.hasData) {
              if (!isFirst) {
                this.isFirst = true;
                print(json.encode(this.result.categories));
